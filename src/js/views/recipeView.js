...
export const clearRecipe = () => {
    DOMinputs.searchRecipe.innerHTML = '';
};
...
export const renderRecipe = (recipe, isLiked) => {
    ...
    <div class="recipe__ingredients">
        <ul class="recipe__ingredient-list">
            ${recipe.ingredients.map(el => getIngredient(el)).join('')}
        </ul>
    ...
    `;
    DOMinputs.searchRecipe.insertAdjacentHTML('afterbegin', markup);
};
